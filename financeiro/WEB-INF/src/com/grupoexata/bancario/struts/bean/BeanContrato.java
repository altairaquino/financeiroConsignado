...
public class BeanContrato implements Serializable {
	...
	private String ctnusbx;
	private String ctcusbx;	
	...
	public String getCtnusbx() {
		return ctnusbx;
	}
	public void setCtnusbx(String ctnusbx) {
		this.ctnusbx = ctnusbx;
	}
	public String getCtcusbx() {
		return ctcusbx;
	}
	public void setCtcusbx(String ctcusbx) {
		this.ctcusbx = ctcusbx;
	}
