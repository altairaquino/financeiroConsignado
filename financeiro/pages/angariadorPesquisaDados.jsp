...
<body>
	...
	<div id="container">
		...
		<fieldset>
			<legend class="red">
				&nbsp;  Pesquisa de Agente de Crédito - Opções Agente de Crédito &nbsp;
			</legend>
			...
			<tbody>
				...
				<tr>
					<td colspan="4">
						<%-- 
						<input type="button" class="btn_hot" value="Relatï¿½rio de Corretores por UF" onclick="window.location = 'actionParametro.do?m=relatorio&tipo=4'">&nbsp;
						<input type="button" class="btn_hot" value="Relatï¿½rio Acompanhamento de Produï¿½ï¿½o de Corretores" onclick="window.location = 'actionParametro.do?m=relatorio&tipo=6'">
						--%>
					</td>
				</tr>
