...
<body>
	...
	<div id="container">
		...
		<fieldset style="text-align: center;">
			<legend class="red">
				&nbsp;   Cadastro de Conta Corrente (Empregado) > <bean:write name="empregado" property="encnome"/>  &nbsp;
			</legend>
			<html:form action="actionContaCorrente" focus="contcon">
			<input type="hidden" name="concgen" value="<bean:write name="empregado" property="enncodg"/>">
			<html:hidden property="m" value="cadastroEmpr"/>
			...
			<tbody>
				...
				<tr>
					<td>
						<input type="button" class="btn" value="Cancelar" onclick="window.location = 'actionContaCorrente.do?m=listaEmpr&enncodg=<bean:write name="empregado" property="enncodg"/>'">
					</td>
