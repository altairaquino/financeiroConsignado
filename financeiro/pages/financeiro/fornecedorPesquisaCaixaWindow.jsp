<%@include file="/pages/topo.jsp" %>
	...
	<script type="text/javascript">
			...
			function sair(ncodg,desc){
				if(opener){
					var movnforn = opener.document.getElementById('movnforn');
					var movcforn = opener.document.getElementById('movcforn');
					if(movnforn && movcforn)
					{	
						movnforn.value = ncodg;
						movcforn.value = desc;
						opener.document.getElementById('movccoco').value = '';
						opener.document.getElementById('movccoco').value = '';
					}
				}
				window.close();
...
<body style="margin: 0px; overflow: hidden;">
	...
	<div id="container" style="width: 500px;">
		...
		<fieldset>
			...
			<html:hidden property="m" value="pesquisaFornecedorWindow"/>
