...
<body>
	...
	<div id="container">
		...
		<fieldset>
			...
			<html:hidden property="m" value="cadastroPeloAngariador"/>
			...
			<tbody>
				...
				<tr>
					...
					<td style="color: red; font-weight: bold;" style="width: 75%">
						<bean:write name="usuario" property="encnome"/>
			...
			<tbody>
				<tr>
					...
					<td style="width: 75%">
						...
						&nbsp;Agência da O.P.&nbsp;<html:text property="ctcagen" maxlength="5" size="5"/>
					</td>
				</tr>
			</tbody>
			</table>
