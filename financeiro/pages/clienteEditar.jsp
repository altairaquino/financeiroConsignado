...
<body>
	...
	<div id="container">
		...
		<fieldset>
			...
			<html:hidden property="m" value="updateCliente"/>
			...
			<tbody>
				...
				<tr>
					<td>
						<input type="button" class="btn_hot" value="Voltar" onclick="window.location = 'actionEntidade.do?m=dadosCliente&enncodg=<bean:write name="formEntidade" property="enncodg"/>'">
					</td>
