	...
	<div id="container">
		...
		<fieldset>
			...
			<tbody>
				<tr>
					<td colspan="4">
						<input type="button" value="Voltar" onclick="window.location = 'actionContrato.do?m=opcoes&ctncodg=<bean:write name="contrato" property="ctncodg"/>'">
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="4">
						...
						<font color="red">
							OBS: ao enviar arquivos evite colocar acentuação e arquivos muito grandes. (Limite de 1mb por arquivo)
						</font> 
					</td>
				</tr>
			</tbody>
