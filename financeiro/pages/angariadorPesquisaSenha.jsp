...
<body>
	...
	<div id="container">
		...
		<fieldset>
			<legend class="red">
				&nbsp;   Pesquisa de Agente de Crédito - Definição de Senha &nbsp;
			</legend>
			<html:form method="action" action="actionEntidade" focus="encnome">
			<html:hidden property="m" value="pesquisaAngariadorSenha"/>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="actionEntidade.do?m=defineSenha&enncodg=<bean:write name="b" property="enncodg"/>">
