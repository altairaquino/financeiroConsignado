...
<body>
	...
	<div id="container">
		...
		<fieldset>
			...
			<html:hidden property="encnome"/>
			<html:hidden property="m" value="updateUsuario"/>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<html:text property="endnasc" size="11" maxlength="10" onkeyup="criaMascara(this, '##/##/####');" ></html:text>(dd/mm/aaaa)
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td colspan="2" style="text-align: right;">
						<html:submit styleClass="btn_hot">Salvar Dados Cadastrais</html:submit>
					</td>
				</tr>				
