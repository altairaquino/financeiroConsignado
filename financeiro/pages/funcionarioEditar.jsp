...
<body>
	...
	<div id="container">
		...
		<fieldset>
			...
			<html:form action="actionEntidade" focus="encnome" onsubmit="return window.confirm('Confirmar a alteração do funcionário com os dados fornecidos?')">
			<html:hidden property="m" value="updateFuncionario"/>
			...
			<tbody>
				...
				<tr>
					<td>
						<input type="button" class="btn_hot" value="Voltar" onclick="window.location = 'actionEntidade.do?m=opcoesFuncionario&enncodg=<bean:write name="formEntidade" property="enncodg"/>'">
					</td>
