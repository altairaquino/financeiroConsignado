...
<body>
	...
	<div id="container">
		...
		<fieldset style="text-align: center;">
			<legend class="red">
				&nbsp;   Cadastro de Funcionários da Regional > <bean:write name="regional" property="rgcdesc"/>  &nbsp;
			</legend>
			<html:form action="actionFuncRegional" focus="frencgtfa">
			<input type="hidden" name="frencgrg" value="<bean:write name="regional" property="rgncodg"/>">
			...
			<tbody>
				<tr>
					<th style="background-color: #DDD;text-align: center" colspan="2">
						Cadastro de Funcionários da Regional
					</th>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						<input type="button" class="btn" value="Cancelar" onclick="window.location = 'actionFuncRegional.do?m=lista&rgncodg=<bean:write name="regional" property="rgncodg"/>'">
					</td>
