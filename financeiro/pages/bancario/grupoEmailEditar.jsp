...
<body>
	...
	<div id="container">
		...
		<fieldset style="text-align: center;">
			<legend>
				&nbsp;   Alteração de Grupo de E-mail    &nbsp;
			</legend>
			<html:form action="actionGrupoEmail" focus="gemcdesc" onsubmit="return window.confirm('Confirmar a alteração do grupo de e-mail com os dados fornecidos?')">
