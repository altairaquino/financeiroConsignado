<%@include file="/pages/topo.jsp" %>
	...
	<script type="text/javascript">
			...
			function sair(ncodg,desc){
				if(opener){
					var fcancgfc = opener.document.getElementById('fcancgfc');
					var fcacnmfc = opener.document.getElementById('fcacnmfc');
					if(fcancgfc && fcacnmfc)
					{	
						fcancgfc.value = ncodg;
						fcacnmfc.value = desc;
					}
				}
				window.close();
...
<body style="margin: 0px; overflow: hidden;">
	...
	<div id="container" style="width: 500px;">
		...
		<fieldset>
			...
			<html:hidden property="m" value="pesquisaFuncionarioAgenciaWindow"/>
