...
<body>
	...
	<div id="container">
		...
		<fieldset style="text-align: center;">
			<legend class="red">
				&nbsp;   Cadastro de Conta Corrente (Fornecedor) > <bean:write name="fornecedor" property="encnome"/>  &nbsp;
			</legend>
			<html:form action="actionContaCorrente" focus="contcon">
			<input type="hidden" name="concgen" value="<bean:write name="fornecedor" property="enncodg"/>">
			<html:hidden property="m" value="cadastroFornec"/>
			...
			<tbody>
				...
				<tr>
					<td>
						<input type="button" class="btn" value="Cancelar" onclick="window.location = 'actionContaCorrente.do?m=listaFornec&enncodg=<bean:write name="fornecedor" property="enncodg"/>'">
					</td>
