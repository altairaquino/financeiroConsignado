...
<body>
	<div id="container">
		...
		<fieldset>
			<legend>
				&nbsp; Atividades > Cadastro de Nova Atividade &nbsp;
			</legend>
            <html:form action="actionAtividade" onsubmit="return window.confirm('Confirmar a inclusão da Atividade com os dados fornecidos?')">
