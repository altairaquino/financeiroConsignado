	...
	<div id="container">
		...
		<fieldset>
			...
			<html:hidden property="m" value="cadastro"/>
            		<html:hidden property="ocpncodg"/>

			<table style="width: 550px;">
			<tbody>
				<tr>
					<th colspan="2" style="text-align: center; background-color: #DDDDDD;">  Cadastro ocupacao (alteração) </th>
				</tr>
                				<tr>
					<td>
						OCPNCODG
					...
					<td>
						<html:text property="ocpncodg" disabled="true"></html:text>
					</td>
				</tr>
				<tr>
					<td>
