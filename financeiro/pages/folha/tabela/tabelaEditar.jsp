...
<body>
	<div id="container">
		...
		<fieldset>
			<legend>
				&nbsp;Cadastro tabela (alteração)&nbsp;
			</legend>
            <html:form action="actionTabela" onsubmit="return window.confirm('Confirmar a alteração do tabela com os dados fornecidos?')">
			<html:hidden property="m" value="update"/>
            		<html:hidden property="tabncodg"/>
            		<html:hidden property="tabncgttb"/>
			<table style="width: 100%;">
			<tbody>
				<tr>
					<th colspan="2" style="text-align: center; background-color: #DDDDDD;">  Cadastro tabela (alteração) </th>
				</tr>
				<tr>
					<td class="style1">
						Limite(R$)
