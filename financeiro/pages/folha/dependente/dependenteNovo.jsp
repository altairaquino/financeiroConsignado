...
<body>
	<div id="container">
		...
		<fieldset>
			<legend>
				&nbsp;Cadastro dependente > <bean:write name="empregado" property="encnome"/>  &nbsp;
			</legend>
            <html:form action="actionDependente" onsubmit="return window.confirm('Confirmar a inclusção do dependente com os dados fornecidos?')">
			<html:hidden property="m" value="cadastro"/>
			<html:hidden property="depncgen"/>
			<table style="width: 100%;">
			<tbody>
				<tr>
					<th colspan="2" style="text-align: center; background-color: #DDDDDD;">  Cadastro dependente </th>
				</tr>
				<tr>
					<td class="style1">
						Nome
