...
<body>
	<div id="container">
		...
		<fieldset>
            ...
            <html:form action="actionEmpregado" onsubmit="return window.confirm('Confirmar a alteração do empregado com os dados fornecidos?')">
			<html:hidden property="m" value="update"/>
			<html:hidden property="empncodg"/>
			...
			<tbody>
				...
				<tr>
					...
					<td style="font-weight: bold;">
						<bean:write name="formEmpregado" property="empcnmen"/>
					</td>
				</tr>
				<tr>
					<td class="style1">
                ...
                <tr>
					...
					<td>
						...
						<html:option value="-1">Selecione a situação do empregado</html:option>
				...
				<tr>
					...
					<td>
						...
						<html:option value="-1">Selecione a categoria do empregado</html:option>
				...
				<tr>
					...
					<td>
						...
						<html:option value="-1">Selecione o vínculo do empregado</html:option>
				...
				<tr>
					...
					<td>
						<html:select property="empncgtad" style="width:350px;">
							<html:option value="-1">Selecione o tipo de admissão do empregado</html:option>
				...
				<tr>
					...
					<td>
						<html:select property="empncggin" style="width:350px;">
							<html:option value="-1">Selecione o grau de instrução do empregado</html:option>
				...
				<tr>
					...
					<td>
						<html:text property="empctitl" size="25" maxlength="25"/>
					</td>
				</tr>
				<tr>
					<td class="style1">
					...
					<td>
						<html:text property="empcrg" size="25" maxlength="25"/>
					</td>
				</tr>
				<tr>
					<td class="style1">
					...
					<td>
						<html:text property="empcorg"  size="6" maxlength="6"/>
					</td>
				</tr>
				<tr>
					<td class="style1">
				...
				<tr>
					...
					<td>
						<html:text property="empcncat" onkeyup="criaMascara(this,'###########');" size="25" maxlength="25"/>
					</td>
				</tr>
				<tr>
					<td class="style1">
					...
					<td>
						<html:text property="empcscat" onkeyup="criaMascara(this,'###########');"  size="25" maxlength="25"/>
					</td>
				</tr>
				<tr>
					<td class="style1">
				...
				<tr>
					...
					<td>
						<html:text property="empcfgts"  size="25" maxlength="25"/>
					</td>
				</tr>
				<tr>
					<td class="style1">
					...
					<td>
						<html:text property="empdfgts" onkeyup="criaMascara(this, '##/##/####');"/>
					</td>
				</tr>
				<tr>
					<td colspan="2">
				...
				<tr>
					...
					<td>
						<html:text property="empccarg" size="45" maxlength="45" style="width:350px;"/>
					</td>
				</tr>
				<tr>
					<td class="style1">
					...
					<td>
						<html:text property="empcpis"  size="25" maxlength="25"/>
					</td>
				</tr>
				<tr>
					<td class="style1">
					...
					<td>
						<html:text property="empnhrsm" onkeyup="criaMascara(this, '##');" size="3"/>
					</td>
				</tr>
				<tr>
					<td class="style1">
					...
					<td>
						<html:text property="empybase" onkeydown="Formata(this,10,event,2)"/>
					</td>
				</tr>
				<tr>
					<td class="style1">
				...
				<tr>
					...
					<td>
						<html:text property="empdadms" onkeyup="criaMascara(this, '##/##/####');" size="11"/>
					</td>
				</tr>
				<tr>
					<td class="style1">
					...
					<td>
						<html:text property="empddems" onkeyup="criaMascara(this, '##/##/####');" size="11"/>
					</td>
				</tr>
				<tr>
					<td class="style1">
					...
					<td>
						<html:text property="empdinat" onkeyup="criaMascara(this, '##/##/####');" size="11"/>
					</td>
				</tr>
				<tr>
					<td class="style1">
					...
					<td>
						<html:text property="empdterm" onkeyup="criaMascara(this, '##/##/####');" size="11"/>
					</td>
				</tr>
				<tr>
					<td class="style1">
					...
					<td>
						<html:text property="empnma13" onkeyup="criaMascara(this,'##');" size="3"/>
					</td>
				</tr>
				<tr>
					<td class="style1">
				...
				<tr>
					...
					<td>
						<html:text property="empycpsg" onkeydown="Formata(this,10,event,2)"/>
					</td>
				</tr>
				<tr>
					<td colspan="2">
				...
				<tr>
					<td>
						<input type="button" class="btn_hot" value="Cancelar" onclick="window.location = 'actionEmpregado.do?m=dados&empncodg=<bean:write name="formEmpregado" property="empncodg"/>'">
					</td>
					<td style="text-align: right;">
						<html:submit styleClass="btn_hot">Salvar Empregado</html:submit>
					</td>
				</tr>
			</tbody>			
			</table>
