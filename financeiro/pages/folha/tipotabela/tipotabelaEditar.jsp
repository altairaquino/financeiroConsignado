...
<body>
	<div id="container">
		...
		<fieldset>
			<legend>
				&nbsp;Cadastro tipotabela (alteração)&nbsp;
			</legend>
            <html:form action="actionTipotabela" onsubmit="return window.confirm('Confirmar a alteração do tipotabela com os dados fornecidos?')">
			...
			<tbody>
				<tr>
					<th colspan="2" style="text-align: center; background-color: #DDDDDD;">  Cadastro tipotabela (alteração) </th>
				</tr>
                				<tr>
					<td class="style1">
						Código
				...
				<tr>
					...
					<td style="text-align: right;">
						<html:submit styleClass="btn_hot">Editar tipotabela</html:submit>
					</td>
				</tr>
			</tbody>			
			</table>
