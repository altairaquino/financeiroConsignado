...
<body>
	<div id="container">
		...
		<fieldset>
            ...
            <html:form action="actionFolhaEmp" onsubmit="return window.confirm('Confirmar a inclusão do folha_emp com os dados fornecidos?')">
			<html:hidden property="m" value="cadastro"/>
			<table style="width: 550px;">
			<tbody>
				<tr>
					<th colspan="2" style="text-align: center; background-color: #DDDDDD;">  Cadastro folha_emp </th>
				</tr>
                				<tr>
					<td>
						FOENCGEMP
