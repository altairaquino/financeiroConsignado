...
<body>
	<div id="container">
		...
		<fieldset>
			<legend>
				&nbsp;Cadastro folha_emp_item (alteração)&nbsp;
			</legend>
			...
			<html:hidden property="m" value="cadastro"/>
            		<html:hidden property="feincodg"/>

			<table style="width: 550px;">
			<tbody>
				<tr>
					<th colspan="2" style="text-align: center; background-color: #DDDDDD;">  Cadastro folha_emp_item (alteração) </th>
				</tr>
                				<tr>
					<td>
						FEINCODG
					...
					<td>
						<html:text property="feincodg" disabled="true"></html:text>
					</td>
				</tr>
				<tr>
					<td>
