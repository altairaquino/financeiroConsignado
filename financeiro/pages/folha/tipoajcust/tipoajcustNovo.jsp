...
<body>
	<div id="container">
		...
		<fieldset>
			...
			<tbody>
				<tr>
					<th colspan="2" style="text-align: center; background-color: #DDDDDD;">  Cadastro Tipo Ajuda de Custo</th>
				</tr>
                				<tr>
					<td class="style1">
						Código
				...
				<tr>
					...
					<td style="text-align: right;">
						<html:submit styleClass="btn_hot">Cadastro Tipo Ajuda de Custo</html:submit>
					</td>
				</tr>
			</tbody>			
			</table>
