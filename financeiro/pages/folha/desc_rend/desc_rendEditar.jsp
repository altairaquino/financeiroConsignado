...
<body>
	<div id="container">
		...
		<fieldset>
			<legend>
				&nbsp;<a href="actionDescRend.do?m=lista">Descontos e Rendimentos</a>&nbsp;>&nbsp;<a href="actionDescRend.do?m=opcao&derncodg=<bean:write name="desc_rend" property="derncodg"/>"><bean:write name="desc_rend" property="dercdesc"/></a>&nbsp;> &nbsp;Dados Básicos&nbsp;
			</legend>
            <html:form action="actionDescRend" onsubmit="return window.confirm('Confirmar a alteração do Descontos e Rendimentos com os dados fornecidos?')">
			...
			<tbody>
				<tr>
					<th colspan="2" style="text-align: center; background-color: #DDDDDD;">  Cadastro de Descontos e Rendimentos (alteração) </th>
				</tr>
				<tr>
					<td class="style1">
						Código
