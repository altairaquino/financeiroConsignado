...
<body>
	...
	<div id="container">
		...
		<fieldset style="text-align: center;">
			<legend>
				&nbsp;   <bean:write name="formContaCorrente" property="cocnmen"/> > Alteração de dados de Conta Corrente (Empregado)   &nbsp;
			</legend>
			<html:form action="actionContaCorrente" focus="concgbc">
			<html:hidden property="concodg"/>
			<html:hidden property="m" value="updateEmpr"/>
			...
			<tbody>
				...
				<tr>
					<td>
						<input type="button" class="btn" value="Cancelar" onclick="window.location = 'actionContaCorrente.do?m=listaEmpr&enncodg=<bean:write name="formContaCorrente" property="concgen"/>'">
					</td>
