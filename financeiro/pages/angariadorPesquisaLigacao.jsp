...
<body>
	...
	<div id="container">
		...
		<fieldset>
			<legend class="red">
				&nbsp;   Pesquisa de Agente de Crédito - Registro de Ligações Call Center &nbsp;
			</legend>
			<html:form method="action" action="actionEntidade" focus="encnome">
			<html:hidden property="m" value="pesquisaAngariadorLigacao"/>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="actionLigacao.do?m=novo&enncodg=<bean:write name="b" property="enncodg"/>">
