	...
	<div id="container">
		...
		<fieldset>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<select name="tipo" style="width: 400px;">
							<option value="1">Relatório de Comissão por Contrato (Sinergia)</option>												
							<option value="2">Relatório de Comissão (Resumido) </option>
							<option value="3">Relatório de Comissões de Funcionários por Agência (PROJETO SINERGIA) </option>
							<option value="4">Relatório Comparativo de Produção Mensal por Agência (PROJETO SINERGIA) </option>
							<option value="5">Relatório Ranking de Digitação (PROJETO SINERGIA) </option>
						</select>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td style="text-align: right;" colspan="2">
						<html:submit styleClass="btn_hot" value="Visualizar Relatório"></html:submit>				
					</td>
				</tr>
