			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<input type="image" src="imagens/cancela.jpg" title="Deletar Conta Corrente" onclick="if (window.confirm('Confirmar a exclusão da conta?')) {window.location = 'actionContaCorrente.do?m=deleteEmpr&concodg=<bean:write name="b" property="concodg"/>'}">
					</td>
				</tr>
				</logic:iterate>
				<tr>
