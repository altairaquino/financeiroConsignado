...
<body>
	...
	<div id="container">
		...
		<fieldset>
			<legend>
				&nbsp;   Altera Cadastro de Fornecedor    &nbsp;
			</legend>
			<html:form action="actionEntidade" focus="encnome" onsubmit="return window.confirm('Confirmar a alteração do fornecedor com os dados fornecidos?')">			
			<html:hidden property="m" value="updateFornecedor"/>
			<html:hidden property="enncodg"/>
			<table style="width: 550px;">
			<tbody>
				<tr>
					<th colspan="2" style="text-align: center; background-color: #DDDDDD;"> 
						Altera Cadastro de Novo Fornecedor
					</th>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						<input type="button" class="btn" value="Cancelar" onclick="window.location = 'actionEntidade.do?m=dadosFornecedor&enncodg=<bean:write name="formEntidade" property="enncodg"/>'">
					</td>
					<td colspan="2" style="text-align: right;">
						<html:submit styleClass="btn_hot">Alterar Fornecedor</html:submit>
					</td>
				</tr>				
