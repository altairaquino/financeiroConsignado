...
<body>
	...
	<div id="container">
		...
		<fieldset style="text-align: center;">
			<legend>
				&nbsp;   <bean:write name="formContaCorrente" property="cocnmen"/> > Alteração de dados de Conta Corrente    &nbsp;
			</legend>
			...
			<tbody>
				...
				<tr>
					<td>
						<input type="button" class="btn" value="Cancelar" onclick="window.location = 'actionContaCorrente.do?m=dados&enncodg=<bean:write name="formContaCorrente" property="concgen"/>'">
					</td>
