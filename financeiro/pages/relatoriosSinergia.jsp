...
<body>
	...
	<div id="container">
		...
		<fieldset>
			...
			<html:hidden property="m" value="relatoriosSinergia"/>
			<center>
				...
				<tr>
					...
					<td>
						<select name="tipo" style="width: 400px;">
							<option value="1">Produção da Agência por data de cadastro</option>
							<option value="2">Comissões dos Funcionários por Contrato</option>
						</select>
					</td>
				</tr>
				<tr>
