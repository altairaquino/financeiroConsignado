...
<body>
	...
	<div id="container">
		...
		<fieldset>
			<legend>
				&nbsp;   Altera Cadastro de Loja de Veículo    &nbsp;
			</legend>
			<html:form action="actionEntidade" focus="encnome">			
			<html:hidden property="m" value="updateLojaVeiculo"/>
			...
			<tbody>
				...
				<tr>
					<td>
						<input type="button" class="btn" value="Cancelar" onclick="window.location = 'actionEntidade.do?m=dadosLojaVeiculo&enncodg=<bean:write name="formEntidade" property="enncodg"/>'">
					</td>
					<td style="text-align: right;">
						<html:submit styleClass="btn_hot">Alterar Loja</html:submit>
					</td>
				</tr>	
