...
<body>
	...
	<div id="container">
		...
		<fieldset>
			<legend>
				&nbsp;   Cadastro de Operador Veículo    &nbsp;
			</legend>
			<html:form action="actionEntidade" focus="encnome">		
			<html:hidden property="m" value="cadastroOperadorVeiculo"/>
			...
			<tbody>
				...
				<tr>
					<td>
						<input type="button" class="btn" value="Cancelar" onclick="window.location = 'actionEntidade.do?m=listaOperadorVeiculo'">
					</td>
					<td style="text-align: right;">
						<html:submit styleClass="btn_hot">Cadastrar Operador</html:submit>
					</td>
				</tr>				
