...
<script type="text/javascript" src="scripts/jquery.js"></script>
	...
	<script type="text/javascript">
			...
			function sair(ncodg,desc){
				if(opener){
					var ctancgop = opener.document.getElementById('ctancgop');
					var ctacnmop = opener.document.getElementById('ctacnmop');
					if(ctancgop && ctacnmop)
					{	
						ctancgop.value = ncodg;
						ctacnmop.value = desc;
					}
				}
				window.close();
...
<body style="margin: 0px; overflow: hidden;">
	...
	<div id="container" style="width: 500px;">
		...
		<fieldset>
			...
			<html:hidden property="m" value="pesquisaOperadorContratoWindow"/>
