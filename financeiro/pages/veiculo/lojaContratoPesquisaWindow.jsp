<%@include file="/pages/topo.jsp" %>
	...
	<script type="text/javascript">
			...
			function sair(ncodg,desc){
				if(opener){
					var ctancglj = opener.document.getElementById('ctancglj');
					var ctacnmlj = opener.document.getElementById('ctacnmlj');
					if(ctancglj && ctacnmlj)
					{	
						ctancglj.value = ncodg;
						ctacnmlj.value = desc;
					}
				}
				window.close();
...
<body style="margin: 0px; overflow: hidden;">
	...
	<div id="container" style="width: 500px;">
		...
		<fieldset>
			<legend>
				&nbsp;Pesquisa Loja de Veículo&nbsp;
			</legend>
			<html:form method="action" action="actionEntidade" focus="encnome">
			<html:hidden property="m" value="pesquisaLojaContratoWindow"/>
