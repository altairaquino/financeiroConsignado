...
<body>
	...
	<div id="container">
		...
		<fieldset>
			<legend>
				&nbsp;   Alteração de Contrato - Veículo    &nbsp;
			</legend>
			<html:form action="actionContratoAuto" onsubmit="return window.confirm('Confirmar a alteração do contrato com os dados fornecidos?')">
