...
<body>
	...
	<div id="container">
		...
		<fieldset>
			...
			<html:form action="actionProcesso">
				...
				<tr>
					...
					<td>
						<select name="tipo" style="width: 400px;">
							<option value="1">Ligações Agendadas</option>
							<option value="2">Ligações Realizadas [DATA]</option>
							<option value="3">Quantidade de Processos por UF/Cidade [DATA DE CADASTRO]</option>
							<option value="4">Quantidade de Processos por Tipo de Processo [DATA DE CADASTRO]</option>
							<option value="5">Audiências Marcadas</option>
						</select>
					</td>
				</tr>
				<tr>
