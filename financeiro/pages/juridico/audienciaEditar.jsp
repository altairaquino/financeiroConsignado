		...
		<fieldset>
			...
			<tbody>
				...
				<tr>
					...
					<td style="width: 75%;">
						<html:text property="adcddata" styleId="data1" size="11" maxlength="10" readonly="true" style="color: #00D; font-weight: bold;"/>
