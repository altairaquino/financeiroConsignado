...
<body>
	...
	<div id="container">
		...
		<fieldset>
			<legend class="red">
				&nbsp;   Registro de Ligação para Contatos do Jurídico  &nbsp;
			</legend>
			...
			<html:form action="actionLigacaoJuridico" method="post" onsubmit="return window.confirm('Confirmar o registro da ligação com os dados fornecidos?')">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<html:radio property="lgjlmail" value="F">Não</html:radio>
					</td>
				</tr>
				<tr>
					<th colspan="2" style="text-align: center;background-color: #DDD;">
