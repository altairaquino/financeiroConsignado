...
<body>
	...
	<div id="container">
		...
		<fieldset>
			<legend>
				&nbsp;   Cadastro de Novo Contato do Jurídico    &nbsp;
			</legend>
			<html:form action="actionEntidade" focus="encnome" onsubmit="return window.confirm('Confirmar a inclusão do Contato com os dados fornecidos?')">			
			<html:hidden property="m" value="cadastroContatoJuridico"/>
			...
			<tbody>
				...
				<tr>
					<td>
						<input type="button" class="btn" value="Cancelar" onclick="window.location = 'actionEntidade.do?m=listaContatoJuridico'">
					</td>
